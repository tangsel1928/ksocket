...
// MODIFIED: Default relay server - ganti ke relay server sendiri
// Override runtime: export GSOCKET_HOST="your-relay.example.com"
// Atau: export GSOCKET_DOMAIN="your-relay.example.com"
#ifndef GS_NET_DEFAULT_HOST
